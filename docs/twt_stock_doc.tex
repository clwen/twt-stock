...
We collected the corresponding stock prices from Yahoo! Fianance. Figure \ref{xyplots-ratio-price} and Figure \ref{xyplots-ratio-price-02} give the reader an overview of the relationship between ratio of sentiment analysis and its stock prices, until week five.
...
\caption{XY plots for ratios of positive Tweets and stock prices}
...
\caption{XY plots for ratios of positive Tweets and stock prices (Con't)}
