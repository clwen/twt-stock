...
Our features can be divided into four categories: count of part-of-speech tags, meta-information, count of twitter-specific syntax, unigram model trained by our training data. We will also propose new features according to our study. Details to be updated in the later check points.
